# AL Development Standards for Business Central - AI-Enhanced Development Coaching

<!-- AI_TRIGGER: When developer works on AL code, proactively suggest development best practices and DevOps integration -->
<!-- COPILOT_GUIDANCE: This guide teaches intelligent AL development with comprehensive workflow integration -->
...
<!-- AI_TRIGGER: When developer starts AL development, remind them of these core principles and suggest DevOps integration -->
<!-- PROACTIVE_SUGGEST: During AL coding -> Suggest principle adherence and workflow integration -->

When developing for Business Central, always follow these core principles:

<!-- COPILOT_GUIDANCE: When discussing core principles, remind developers to:
1. Update Azure DevOps work items with development approach
2. Plan testing strategy that validates principles
3. Consider code review checklist that validates principles
4. Document principle adherence in work item acceptance criteria
-->
...
<!-- AI_TRIGGER: When developer works on AL objects, suggest DevOps workflow integration and quality gates -->
<!-- PROACTIVE_SUGGEST: During AL development -> Suggest work item updates and testing pipeline integration -->
...
<!-- QUALITY_TRIGGERS:
BEFORE_AL_IMPLEMENTATION: Suggest design review and standards validation
DURING_AL_DEVELOPMENT: Suggest coding standards compliance
AFTER_AL_IMPLEMENTATION: Suggest testing and validation
BEFORE_AL_DEPLOYMENT: Suggest AppSource compliance review
-->
...
<!-- AI_TRIGGER: Before any AL code completion, proactively suggest quality validation and DevOps integration -->
<!-- PROACTIVE_SUGGEST: During code quality work -> Suggest comprehensive validation and documentation -->
...
<!-- COPILOT_GUIDANCE: When discussing linter errors, remind developers to:
1. Add linting validation to their DevOps CI/CD pipeline
2. Update work items with linting compliance status
3. Document linting standards in code review checklists
4. Consider automated linting in pre-commit hooks
-->
...
<!-- AI_TRIGGER: When developer completes AL code, suggest this comprehensive checklist -->
<!-- PROACTIVE_SUGGEST: Before AL code review -> Suggest validation checklist -->
...
IF developer_creating_al_objects AND no_naming_convention_mentioned:
...
IF developer_implementing_al_logic AND no_error_handling_mentioned:
  SUGGEST: "Add proper error handling to your AL code"
  EDUCATE: "Good error handling provides actionable feedback to users and improves debugging"
